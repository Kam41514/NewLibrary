...
function ThemeManager:BuildThemeSection(Tab)
    ...
    ThemeInput = Groupbox:AddInput("ThemeName", {
        Text = "Theme Name",
        Default = self.CurrentTheme or self.StartupTheme or "MoonHub",
        Placeholder = "Theme name...",
        ClearTextOnFocus = false,
        Callback = function(Value)
            local Name = tostring(Value or "MoonHub")
            if Name == "" then
                Name = "MoonHub"
            end
            self.CurrentTheme = Name
    ...
    local function RefreshThemeDropdown()
        ...
        local Current = tostring(self.CurrentTheme or self.StartupTheme or "MoonHub")
        ...
        if #ThemeNames == 0 then
            ThemeNames = { self.StartupTheme or "MoonHub" }
            DefaultTheme = 1
        end
        ...
        SavedThemesDropdown = Groupbox:AddDropdown("SavedThemes", {
            ...
            Callback = function(Value)
                ...
                if ThemeInput and ThemeInput.SetValue then
                    ThemeInput:SetValue(self.CurrentTheme)
                end
            end,
        })
    end
    ...
    Groupbox:AddButton("SaveTheme", {
        Text = "Save Theme",
        Callback = function()
            local Name = tostring(self.CurrentTheme or self.StartupTheme or "MoonHub")
    ...
    Groupbox:AddButton("DeleteTheme", {
        ...
        Callback = function()
            ...
            if Name ~= self.StartupTheme then
